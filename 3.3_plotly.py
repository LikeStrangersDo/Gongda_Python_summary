...
#    When presenting via online platforms like "Zoom", open all html files in advance. Then just switch between your slides and the html tabs using functions like "New Share".
