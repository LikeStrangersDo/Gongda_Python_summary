## Python notes for research computing in atmospheric chemistry
...
After knowing some basics, jump to Numpy and Pandas directly. Then you will be able to use Python in your research very soon! See suggestions from [Jiawei Zhuang (author of GEOS-Chem Python)](https://github.com/geoschem/GEOSChem-python-tutorial#how-to-learn-python).

For questions that you can not solve, you can always find solutions online, particularly on Stack Overflow: https://stackoverflow.com/.
