...
## Tutorials
My notes here are more about quick references, and they are not necessarily the best or the only solutions to your specific problems. To learn Python, I recommend the tutorials below. They provide datasets with the codes, so you can actually run the codes and see the results from each step. For GEOS-Chem users, I particularly recommend the GEOS-Chem Python tutorial by Jiawei Zhuang. It gets you working with Python immediately.
